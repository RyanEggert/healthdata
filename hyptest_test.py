...
class DiffMeansPermute(thinkstats2.HypothesisTest):
    """Performs difference-of-means hypothesis test. From Allen Downey's "Think Stats 2".
    """
...
def test_diffmean_hyp(filename, var1, var2):
    """Performs hypothesis test using a dataset from "filename". 
        It examines the average difference in "var2" between those for whom var1 is true
        and those for whom var1 is false.

        filename: .pkl file containing the dataset
        var1: variable that divides dataset into two groups (var1 is true, var1 is false)
        var2: variable for which the difference in means is calculated (var2 mean for group 1 minus
            var2 mean for group 2)
    
        Returns: dictionary containing size of groups, means, difference in means, p-value
    """
    d = {}
